    ...
    <section id="home-page">
            ...
            <div className="container">
              ...
              <div className="search-container">
                <form onSubmit={searchAll}>
                  ...
                  <button type="submit" id="search" className="btn">Search</button>
                </form>
              </div>
        ...
        <div className="container">
          ...
          <h2 id="subtag">Connect. Collaborate. Create</h2>
            <div className="text">
              <p id="description">bootMate() is a platform for developers to connect and collaborate on projects. 
              <br></br>
              <br></br>
              Whether you're looking to start a new project or join an existing one, bootMate() is the place for you.</p>
              <h4 id="subtext">Login or Sign up today to get started!</h4>
            </div>

          <div className="login">
            <button className="btn" id="login" onClick={togglePop}>Login</button>
